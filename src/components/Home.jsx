  ...
  return (
    <>
      <div className="home" id="home">
        <main>
          <h1>TECHPULSE</h1>
          <p>Providing you the best services.</p>
        </main>
      </div>
      <div className="home2">
      ...
      <div className="home3" id="about">
        <div>
          ...
          <p>
            ...
            nemo. qui fullam officia fugiat corrupti odio, suscipit ipsum cum
            vel nemo.uga quae repellat sunt, non natus, iure ab officia rem ipsa
            cum sed
          </p>
        </div>
      </div>
